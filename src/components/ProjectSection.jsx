              ...
              <div className="p-6 text-left md:p-7">
                ...
                <div className="mt-5 flex flex-wrap gap-2">
                  {project.tags.map((tag) => (
                    <span key={tag} className="rounded-full border border-border bg-background px-3 py-1 text-xs font-bold">
                      {tag}
                    </span>
                  ))}
                </div>
                ...
                <div className="mt-6 grid gap-3 sm:grid-cols-3">
                  {project.impact.map((item) => (
                    <div key={item} className="rounded-lg border border-border bg-primary/10 px-3 py-3 text-sm font-bold text-primary">
                      {item}
                    </div>
                  ))}
                </div>
